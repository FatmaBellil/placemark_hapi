...
import { maggie, maggieCredentials, landscape, testCategories } from "../fixtures.js";
...
suite("Category API tests", () => {
  ...
  test("create a category", async () => {
    const returnedCategory = await placemarkService.createCategory(landscape);
    assert.isNotNull(returnedCategory);
    assertSubset(landscape, returnedCategory);
  });

  test("delete a category", async () => {
    const Category = await placemarkService.createCategory(landscape);
